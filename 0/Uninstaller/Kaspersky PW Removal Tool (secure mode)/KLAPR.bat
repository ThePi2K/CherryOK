@echo off
echo Kaspersky Lab AllProducts Password Reset v1.8
pause
REM Kaspersky Lab AllProducts Password Reset v1.8
REM By Matteo Rivoira & Luca Interrante - Kaspersky Lab Italy
REM Support home products from 2013 to 2021
...
REM FIND THE PRODUCT:

REM AVP21MR14_x86
set PRODUCT=21.14 x86
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\KasperskyLab\AVP21.14\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21

REM AVP21MR14_x64
set PRODUCT=21.14 x64
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\KasperskyLab\AVP21.14\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21

REM AVP21MR13_x86
set PRODUCT=21.13 x86
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\KasperskyLab\AVP21.13\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21

REM AVP21MR13_x64
set PRODUCT=21.13 x64
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\KasperskyLab\AVP21.13\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21

REM AVP21MR9_x86
set PRODUCT=21.9 x86
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\KasperskyLab\AVP21.9\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21

REM AVP21MR9_x64
set PRODUCT=21.9 x64
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\KasperskyLab\AVP21.9\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21

REM AVP21MR8_x86
set PRODUCT=21.8 x86
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\KasperskyLab\AVP21.8\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21

REM AVP21MR8_x64
set PRODUCT=21.8 x64
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\KasperskyLab\AVP21.8\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21

REM AVP21MR7_x86
set PRODUCT=21.7 x86
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\KasperskyLab\AVP21.7\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21

REM AVP21MR7_x64
set PRODUCT=21.7 x64
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\KasperskyLab\AVP21.7\settings\PasswordProtectionSettings" 
REG QUERY !KEY_NAME! /v !VALUEB_NAME! >nul 2>&1 
if %errorlevel%==0 goto Rexist21
