...
:: ON FIRST COUNT: SET TERMINAL AS DEFAULT COMMAND PROMPT ::
if !counter! equ 1 (
    reg add "HKEY_CURRENT_USER\Console\%%Startup" /v "DelegationConsole" /t REG_SZ /d "{2EACA947-7F5F-4CFA-BA87-8F7FBEEFBE69}" /F >nul
